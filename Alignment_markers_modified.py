...
#create numbers grid as one cell
...
#                                         db.DVector(separation*10*alignment_distance, 0),
#                                         db.DVector(0, separation*10*alignment_distance),
#                                         number_of_grids//separation,
#                                         number_of_grids//separation)
...
ly.write('alignment markers.gds')
